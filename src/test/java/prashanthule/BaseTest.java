...
public class BaseTest {
	...
	public void configAppium() throws MalformedURLException {
		...
		/*
		 * options.setApp(
		 * "F://eclipse-workspace-2022-2023//MobileTesting//src//test//java//resources//ApiDemos-debug.apk"
		 * );
		 */
		options.setApp("F://eclipse-workspace-2022-2023//MobileTesting//src//test//java//resources//General-Store.apk");
